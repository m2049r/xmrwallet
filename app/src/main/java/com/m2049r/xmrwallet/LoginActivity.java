...
public class LoginActivity extends SecureActivity
        ...
        private class AsyncBackupToFile extends AsyncTask<String, Void, Boolean> {
            @Override
            protected void onPreExecute() {
                super.onPreExecute();
       ...
       /*
         modified into onWalletBackupToFile
        @Override
        ...
        public void onWalletBackupToFile(String walletName) {
            Timber.d("backup to file for wallet ." + walletName + ".");
            new AsyncBackupToFile().execute(walletName);
        }

        @Override
        public void onWalletBackupToNFC(String walletName) {
            Timber.d("backup to nfc for wallet ." + walletName + ".");
